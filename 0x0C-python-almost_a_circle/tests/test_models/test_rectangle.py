...
class TestRectangle(unittest.TestCase):
    def setUp(self):
        self.rectangle = Rectangle(width=10, height=20, x=5, y=10)
    ...
    def test_update(self):
        rectangle_2 = Rectangle(width=20, height=30)
        rectangle_2.update(width=10, height=20, x=5, y=10)
        self.assertEqual(rectangle_2, self.rectangle)
    ...
    def test_to_dictionary(self):
        ...
        self.assertEqual(expected, self.rectangle.to_dictionary())